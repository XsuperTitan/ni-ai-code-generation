...
import com.nini.niaicodeking.model.enums.ChatHistoryMessageTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        // 9. 返回可访问的 URL
        return String.format("%s/%s/", StrUtil.removeSuffix(appDeployHost, "/"), deployKey);
    }
